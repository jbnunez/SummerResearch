...
from keras.layers import Input, Flatten, Conv2D, MaxPooling2D, Lambda
import pickle
...
layer7 = Conv2D(4, kernel_size=(8, 8), strides=(1, 1)
    , activation='relu')(layer6)
layer8 = MaxPooling2D(pool_size=(2, 2))(layer7)
layer9 = Flatten()(layer8)
layer10 = Dense(800, activation='relu')(layer9)
encoded = Dense(encoding_dim, activation='relu')(layer10)
...
#rescale the output to be between 0 and 255
